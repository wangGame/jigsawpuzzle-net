...
public class AndroidLiveWallpaper implements AndroidApplicationBase {
	...
	public void initialize (ApplicationListener listener, AndroidApplicationConfiguration config) {
		...
		// Unlike activity, fragment and daydream applications there's no need for a specialized sound listener.
	...
	public void onPause () {
		...
		// also I moved sound lifecycle methods from AndroidGraphicsLiveWallpaper into this class
	...
	public void onDestroy () {
		...
		if (audio != null) {
			// dispose sound and free native resources, mandatory since graphics.pause is never called in live wallpaper
			audio.dispose();
		}
	}
