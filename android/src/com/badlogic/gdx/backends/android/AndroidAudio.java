...
public final class AndroidAudio implements Audio {
	...
	public AudioDevice newAudioDevice (int samplingRate, boolean isMono) {
		if (soundPool == null) {
			throw new GdxRuntimeException("Android sound is not enabled by the application config.");
		}
	...
	public Music newMusic (FileHandle file) {
		...
		if (aHandle.type() == FileType.Internal) {
			try {
				...
				throw new GdxRuntimeException("Error loading sound file: " + file
					+ "\nNote: Internal sound files must be placed in the assets directory.", ex);
			}
		} else {
			try {
				...
				throw new GdxRuntimeException("Error loading sound file: " + file, ex);
			}
		}

	}

	/** Creates a new Music instance from the provided FileDescriptor. It is the caller's responsibility to closed the file
	...
	public Music newMusic (FileDescriptor fd) {
		...
		try {
			...
			throw new GdxRuntimeException("Error loading sound from FileDescriptor", ex);
		}
	}
