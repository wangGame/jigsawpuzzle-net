 ...
 * @author Nathan Sweet */
public class Label4 extends Widget {
	static private final Color tempColor = new Color();
	static private final com.kw.gdx.label.GlyphLayout4 prefSizeLayout = new com.kw.gdx.label.GlyphLayout4();

	private LabelStyle style;
	private final com.kw.gdx.label.GlyphLayout4 layout = new com.kw.gdx.label.GlyphLayout4();
	...
	public Label4 (CharSequence text, Skin skin) {
		this(text, skin.get(LabelStyle.class));
	}

	public Label4 (CharSequence text, Skin skin, String styleName) {
	 ...
	 * myColorAction. */
	public Label4 (CharSequence text, Skin skin, String fontName, Color color) {
		this(text, new LabelStyle(skin.getFont(fontName), color));
	}

	/** Creates a com.kw.gdx.label, using a {@link LabelStyle} that has a BitmapFont with the specified name and the specified myColorAction from the
	 * skin. */
	public Label4 (CharSequence text, Skin skin, String fontName, String colorName) {
		this(text, new LabelStyle(skin.getFont(fontName), skin.getColor(colorName)));
	}

	public Label4 (CharSequence text, LabelStyle style) {
	...
	private void computePrefSize () {
		...
		com.kw.gdx.label.GlyphLayout4 prefSizeLayout = Label4.prefSizeLayout;
	...
	public void layout () {
		...
		com.kw.gdx.label.GlyphLayout4 layout = this.layout;
